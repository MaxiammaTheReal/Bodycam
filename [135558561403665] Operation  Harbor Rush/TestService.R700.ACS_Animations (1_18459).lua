-- Name: ACS_Animations
-- Path: game:GetService("TestService").R700.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.9295082000007824 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:27
-- Luau version 6, Types version 3
-- Time taken: 0.021742 seconds
...
function module_upvr.TacticalReloadAnim(arg1) -- Line 70
	...
	arg1[4].Mag.Transparency = 0
	wait(0.2)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.2, Enum.EasingStyle.Sine), {
		C1 = module_upvr.RArmCFrame:Inverse();
	}):Play()
	...
	wait(0.2)
	local WeldConstraint_2 = Instance.new("WeldConstraint", arg1[4])
	WeldConstraint_2.Part0 = arg1[4].Handle
	WeldConstraint_2.Part1 = arg1[5]["Left Arm"]
	arg1[3].Part0 = nil
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.2, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.25, -0.2, 0.75) * CFrame.Angles(2.0943951023931953, 0, 0):inverse();
	}):Play()
	wait(0.2)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.2, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.25, -0.5, 0.5) * CFrame.Angles(3.0543261909900767, 0, 0):inverse();
	}):Play()
...
function module_upvr.PumpAnim(arg1) -- Line 128
	--[[ Upvalues[2]:
		[1]: TweenService_upvr (readonly)
		[2]: module_upvr (readonly)
	]]
...
function module_upvr.MagCheck(arg1) -- Line 163
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	arg1[4].Handle.AimUp:Play()
...
function module_upvr.meleeAttack(arg1) -- Line 175
end
function module_upvr.GrenadeReady(arg1) -- Line 179
end
function module_upvr.GrenadeThrow(arg1) -- Line 183
end
