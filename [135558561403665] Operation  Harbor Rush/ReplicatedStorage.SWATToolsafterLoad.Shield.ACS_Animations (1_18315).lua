-- Name: ACS_Animations
-- Path: game:GetService("ReplicatedStorage").SWATToolsafterLoad.Shield.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.7661533999998937 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:01
-- Luau version 6, Types version 3
-- Time taken: 0.018890 seconds

local TweenService_upvr = game:GetService("TweenService")
local module_upvr = {
	MainCFrame = CFrame.new(0.5, -0.85, -0.75);
	GunModelFixed = true;
	GunCFrame = CFrame.new(0.2, -0.2, 0.85) * CFrame.Angles((math.pi/2), 0, 0);
	RArmCFrame = CFrame.new(0.05, -0.15, 1) * CFrame.Angles((math.pi/2), 0, 0);
	LArmCFrame = CFrame.new(-1.05, -0.15, 1) * CFrame.Angles((math.pi/2), 0, 0);
}
...
function module_upvr.LowReady(arg1) -- Line 25
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-1.05, -0.15, 1) * CFrame.Angles(1.1344640137963142, 0, 0):inverse();
	}):Play()
	wait(0.25)
end
function module_upvr.HighReady(arg1) -- Line 31
	...
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.05, -0.15, 0.25) * CFrame.Angles(2.356194490192345, 0, 0):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-1.05, -0.15, 0.25) * CFrame.Angles(2.356194490192345, 0, 0):inverse();
	}):Play()
	wait(0.25)
end
...
function module_upvr.JammedAnim(arg1) -- Line 119
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.PumpAnim(arg1) -- Line 133
end
function module_upvr.MagCheck(arg1) -- Line 137
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	arg1[4].Handle.AimUp:Play()
...
function module_upvr.meleeAttack(arg1) -- Line 149
end
function module_upvr.GrenadeReady(arg1) -- Line 153
end
function module_upvr.GrenadeThrow(arg1) -- Line 157
end
module_upvr.SV_GunPos = CFrame.new(-0.5, -0.1, -0.2) * CFrame.Angles(-1.9198621771937625, 0, 0)
module_upvr.SV_RightArmPos = CFrame.new(-0.8, 1.25, -0.35) * CFrame.Angles(-0.8726646259971648, 0, 0)
module_upvr.SV_LeftArmPos = CFrame.new(0.8, 1.25, -0.35) * CFrame.Angles(-0.8726646259971648, 0, 0)
...
module_upvr.LeftHighReady = CFrame.new(1.1, 0.5, -1.1) * CFrame.Angles((-math.pi/2), 0, 0)
module_upvr.RightElbowHighReady = CFrame.new(0, -0.25, -0.35) * CFrame.Angles(-0.7853981633974483, 0, 0)
module_upvr.LeftElbowHighReady = CFrame.new(0, -0.25, -0.35) * CFrame.Angles(-0.7853981633974483, 0, 0)
...
module_upvr.LeftLowReady = CFrame.new(0.9, 1.25, 0) * CFrame.Angles(0, 0, 0)
module_upvr.RightElbowLowReady = CFrame.new(0, -0.45, -0.25) * CFrame.Angles(-1.3962634015954636, 0, 0)
module_upvr.LeftElbowLowReady = CFrame.new(0, -0.45, -0.25) * CFrame.Angles(-1.3962634015954636, 0, 0)
module_upvr.RightWristLowReady = CFrame.new(0, 0, 0.15) * CFrame.Angles(0.3490658503988659, 0, 0)
module_upvr.LeftWristLowReady = CFrame.new(0, 0, 0.15) * CFrame.Angles(0.3490658503988659, 0, 0)
module_upvr.RightPatrol = CFrame.new(-0.85, 0.75, -1.3) * CFrame.Angles(-0.5235987755982988, (-math.pi/2), 0)
module_upvr.LeftPatrol = CFrame.new(0.85, 0.75, -1.3) * CFrame.Angles(-0.5235987755982988, (-math.pi/2), 0)
module_upvr.RightElbowPatrol = CFrame.new(0, -0.2, -0.1) * CFrame.Angles(-0.6981317007977318, 0, 0)
module_upvr.LeftElbowPatrol = CFrame.new(0, -0.2, -0.1) * CFrame.Angles(-0.6981317007977318, 0, 0)
module_upvr.RightWristPatrol = CFrame.new(0, 0, 0) * CFrame.Angles(0, 0, -0.2617993877991494)
module_upvr.LeftWristPatrol = CFrame.new(0, 0, 0) * CFrame.Angles(0, 0, -0.2617993877991494)
module_upvr.RightAim = CFrame.new(-0.8, 1.25, -0.35) * CFrame.Angles(-0.8726646259971648, 0, 0)
module_upvr.LeftAim = CFrame.new(0.8, 1.25, -0.35) * CFrame.Angles(-0.8726646259971648, 0, 0)
