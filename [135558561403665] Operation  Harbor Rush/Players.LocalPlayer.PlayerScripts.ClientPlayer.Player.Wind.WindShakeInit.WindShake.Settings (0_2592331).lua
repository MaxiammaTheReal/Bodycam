-- Name: Settings
-- Path: game:GetService("Players").LocalPlayer.PlayerScripts.ClientPlayer.Player.Wind.WindShakeInit.WindShake.Settings
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.6331780000000435 seconds
