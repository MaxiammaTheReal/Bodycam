-- Name: ACS_Animations
-- Path: game:GetService("ReplicatedStorage").SWATToolsafterLoad.M870.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.6988509999991948 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:05
...
local module_upvr = {
	...
	LArmCFrame = CFrame.new(-0.6, -0.25, -1) * CFrame.Angles(1.9198621771937625, 0.2617993877991494, 0.2617993877991494);
...
function module_upvr.ReloadAnim(arg1) -- Line 49
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.3, Enum.EasingStyle.Back), {
		C1 = CFrame.new(-1, -0.15, 0.5) * CFrame.Angles(1.0471975511965976, -0.08726646259971647, -0.2617993877991494):inverse();
	}):Play()
	wait(0.35)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.05, -0.15, 1) * CFrame.Angles(1.9198621771937625, -0.2617993877991494, 0):inverse();
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.4, -0.25, 0) * CFrame.Angles(2.0943951023931953, -0.2617993877991494, 0.5235987755982988):inverse();
	}):Play()
	wait(0.25)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.05, -0.15, 1) * CFrame.Angles(1.9198621771937625, -0.2617993877991494, 0):inverse();
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.4, -0.15, 0) * CFrame.Angles(2.0943951023931953, -0.2617993877991494, 0.5235987755982988):inverse();
	}):Play()
	arg1[4].Handle.MagIn:Play()
	wait(0.25)
end
function module_upvr.TacticalReloadAnim(arg1) -- Line 62
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.6, -0.25, -0.25) * CFrame.Angles(1.9198621771937625, 0.2617993877991494, 0.2617993877991494):inverse();
	}):Play()
	...
	wait(0.25)
	local WeldConstraint = Instance.new("WeldConstraint", arg1[4])
	WeldConstraint.Part0 = arg1[4].Handle
	WeldConstraint.Part1 = arg1[5]["Left Arm"]
	arg1[3].Part0 = nil
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Back), {
		C1 = CFrame.new(0.75, -0.75, 0) * CFrame.Angles(1.0471975511965976, 0.3490658503988659, 0.5235987755982988):inverse();
	}):Play()
	wait(0.35)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.2, 0.2, 0.75) * CFrame.Angles((math.pi/2), 0.4363323129985824, 0):inverse();
	}):Play()
	wait(0.25)
	arg1[4].Handle.MagIn:Play()
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.2, 0.2, 0.7) * CFrame.Angles((math.pi/2), 0.4363323129985824, 0):inverse();
	}):Play()
	wait(0.25)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.05, -0.15, 1) * CFrame.Angles((math.pi/2), 0, 0):inverse();
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.6, -0.25, -1) * CFrame.Angles(1.9198621771937625, 0.2617993877991494, 0.2617993877991494):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[4].Handle.Bolt, TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.JammedAnim(arg1) -- Line 95
end
function module_upvr.PumpAnim(arg1) -- Line 99
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.MagCheck(arg1) -- Line 116
end
function module_upvr.meleeAttack(arg1) -- Line 120
end
function module_upvr.GrenadeReady(arg1) -- Line 124
end
function module_upvr.GrenadeThrow(arg1) -- Line 128
end
