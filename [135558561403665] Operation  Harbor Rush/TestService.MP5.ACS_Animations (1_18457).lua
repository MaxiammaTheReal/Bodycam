-- Name: ACS_Animations
-- Path: game:GetService("TestService").MP5.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.7672636000006605 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:26
...
local module_upvr = {
	...
	LArmCFrame = CFrame.new(-0.6, -0.1, -0.2) * CFrame.Angles(1.9198621771937625, 0.2617993877991494, 0.2617993877991494);
	RArmCFrame = CFrame.new(0.05, -0.15, 0.85) * CFrame.Angles((math.pi/2), 0, 0);
}
...
function module_upvr.SprintAnim(arg1) -- Line 25
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.LowReady(arg1) -- Line 31
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.6, -0.5, 0) * CFrame.Angles(1.4835298641951802, 0.2617993877991494, 0.2617993877991494):inverse();
	}):Play()
	wait(0.25)
end
...
function module_upvr.ReloadAnim(arg1) -- Line 49
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.05, -0.15, 0.85) * CFrame.Angles(1.9198621771937625, -0.2617993877991494, 0):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.65, 0, 0.2) * CFrame.Angles(1.9198621771937625, -0.2617993877991494, 0.5235987755982988):inverse();
	}):Play()
	wait(0.3)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.5, Enum.EasingStyle.Back), {
		C1 = CFrame.new(0.05, -0.15, 0.85) * CFrame.Angles(1.7453292519943295, -0.08726646259971647, 0):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Back), {
		C1 = CFrame.new(-0.75, -0.15, 1) * CFrame.Angles(1.0471975511965976, -0.08726646259971647, 0.2617993877991494):inverse();
	}):Play()
	wait(0.05)
	...
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.15, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.05, -0.15, 0.85) * CFrame.Angles(1.7627825445142729, -0.10471975511965978, 0):inverse();
	}):Play()
	arg1[4].Mag.Transparency = 0
	wait(0.2)
end
function module_upvr.TacticalReloadAnim(arg1) -- Line 70
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.05, -0.15, 0.85) * CFrame.Angles((math.pi/2), 0, 0):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.65, 0.1, -0.15) * CFrame.Angles((math.pi/2), 1.0471975511965976, 0.5235987755982988):inverse();
	}):Play()
	wait(0.25)
	arg1[4].Bolt.SlidePull:Play()
	TweenService_upvr:Create(arg1[4].Handle.Slide, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {
		C0 = CFrame.new(0, 0, -0.3):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[4].Handle.Bolt, TweenInfo.new(0.15, Enum.EasingStyle.Sine), {
		C0 = CFrame.new(0, 0, -0.3):inverse();
	}):Play()
	...
	wait(0.25)
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.55, 0.15, 0.2) * CFrame.Angles(2.792526803190927, 0, 0.2617993877991494):inverse();
	}):Play()
	wait(0.25)
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Back), {
		C1 = CFrame.new(-0.6, -0.15, 0.2) * CFrame.Angles(1.2217304763960306, -0.2617993877991494, 0.2617993877991494):inverse();
	}):Play()
	wait(0.05)
	TweenService_upvr:Create(arg1[4].Handle.Slide, TweenInfo.new(0.15, Enum.EasingStyle.Linear), {
		C0 = CFrame.new():inverse();
	}):Play()
	TweenService_upvr:Create(arg1[4].Handle.Bolt, TweenInfo.new(0.15, Enum.EasingStyle.Linear), {
		C0 = CFrame.new():inverse();
	}):Play()
	arg1[4].Bolt.SlideRelease:Play()
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.15, Enum.EasingStyle.Back), {
		C1 = CFrame.new(0.05, -0.15, 0.85) * CFrame.Angles(1.4835298641951802, 0, 0):inverse();
	}):Play()
	wait(0.25)
end
function module_upvr.JammedAnim(arg1) -- Line 110
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.PumpAnim(arg1) -- Line 124
end
function module_upvr.MagCheck(arg1) -- Line 128
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	arg1[4].Handle.AimUp:Play()
...
function module_upvr.meleeAttack(arg1) -- Line 140
end
function module_upvr.GrenadeReady(arg1) -- Line 144
end
function module_upvr.GrenadeThrow(arg1) -- Line 148
end
