-- Name: ACS_Animations
-- Path: game:GetService("ReplicatedStorage").SWATToolsafterLoad.HK416A5.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.7505208999991737 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:12
-- Luau version 6, Types version 3
-- Time taken: 0.021376 seconds
...
local module_upvr = {
	...
	LArmCFrame = CFrame.new(-0.4, -0.3, -1) * CFrame.Angles(1.9198621771937625, 0.7504915783575618, 0.2617993877991494);
...
function module_upvr.SprintAnim(arg1) -- Line 49
	...
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.44, -0.3, 0.7) * CFrame.Angles((math.pi/2), 0.3490658503988659, -0.4363323129985824):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.6, -0.8, -0.68) * CFrame.Angles(2.181661564992912, 0.7853981633974483, -0.4363323129985824):inverse();
	}):Play()
	wait(0.25)
end
