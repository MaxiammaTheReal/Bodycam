-- Name: ACS_Animations
-- Path: game:GetService("TestService").HK33.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.7541474999998172 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:33
-- Luau version 6, Types version 3
-- Time taken: 0.021330 seconds
...
local module_upvr = {
	...
	LArmCFrame = CFrame.new(-0.6, -0.15, -0.25) * CFrame.Angles(1.9198621771937625, 0.2617993877991494, 0.2617993877991494);
...
function module_upvr.SprintAnim(arg1) -- Line 43
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.TacticalReloadAnim(arg1) -- Line 70
	...
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.65, 0.1, -0.5) * CFrame.Angles((math.pi/2), 1.0471975511965976, 0.5235987755982988):inverse();
	}):Play()
	wait(0.25)
	...
	wait(0.25)
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.55, 0.15, 0.3) * CFrame.Angles(2.792526803190927, 0, 0.2617993877991494):inverse();
	}):Play()
	wait(0.25)
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Back), {
		C1 = CFrame.new(-0.6, -0.15, 0.3) * CFrame.Angles(1.2217304763960306, -0.2617993877991494, 0.2617993877991494):inverse();
	}):Play()
	wait(0.05)
	...
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.15, Enum.EasingStyle.Back), {
		C1 = CFrame.new(0.05, -0.15, 1) * CFrame.Angles(1.4835298641951802, 0, 0):inverse();
	}):Play()
	wait(0.25)
end
function module_upvr.JammedAnim(arg1) -- Line 110
	...
	TweenService_upvr:Create(arg1[4].Handle.Bolt, TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C0 = CFrame.new(0, 0, -0.7):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(-0.65, 0.1, 0.15) * CFrame.Angles((math.pi/2), 1.0471975511965976, 0.5235987755982988):inverse();
