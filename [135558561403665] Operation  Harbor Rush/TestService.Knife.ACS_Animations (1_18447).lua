-- Name: ACS_Animations
-- Path: game:GetService("TestService").Knife.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.5565239000006841 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:17
-- Luau version 6, Types version 3
-- Time taken: 0.008845 seconds

local TweenService_upvr = game:GetService("TweenService")
local module_upvr = {
	MainCFrame = CFrame.new(0, 0, 0);
	GunModelFixed = true;
	GunCFrame = CFrame.new(0.15, 0, 0.85) * CFrame.Angles((math.pi/2), 0, 0);
...
function module_upvr.EquipAnim(arg1) -- Line 11
	...
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0, Enum.EasingStyle.Linear), {
		C1 = CFrame.new(1, -1, 1) * CFrame.Angles(math.pi, 0.6108652381980153, -2.0943951023931953):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0, Enum.EasingStyle.Linear), {
...
function module_upvr.ReloadAnim(arg1) -- Line 43
end
function module_upvr.TacticalReloadAnim(arg1) -- Line 47
end
function module_upvr.JammedAnim(arg1) -- Line 51
end
function module_upvr.PumpAnim(arg1) -- Line 55
end
function module_upvr.MagCheck(arg1) -- Line 59
end
function module_upvr.meleeAttack(arg1) -- Line 63
	--[[ Upvalues[2]:
		[1]: TweenService_upvr (readonly)
		[2]: module_upvr (readonly)
	]]
	...
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Back), {
		C1 = CFrame.new(1.5, -0.85, 0) * CFrame.Angles(math.pi, 2.792526803190927, -1.4835298641951802):inverse();
	}):Play()
	wait(0.3)
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.35, Enum.EasingStyle.Back), {
		C1 = module_upvr.RArmCFrame:Inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.35, Enum.EasingStyle.Back), {
		C1 = module_upvr.LArmCFrame:Inverse();
	}):Play()
	wait(0.1)
end
function module_upvr.GrenadeReady(arg1) -- Line 75
end
function module_upvr.GrenadeThrow(arg1) -- Line 79
end
