-- Name: ACS_Animations
-- Path: game:GetService("TestService").USP.ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.7295536000001448 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:30
-- Luau version 6, Types version 3
-- Time taken: 0.020884 seconds
...
function module_upvr.JammedAnim(arg1) -- Line 101
	--[[ Upvalues[2]:
		[1]: TweenService_upvr (readonly)
		[2]: module_upvr (readonly)
	]]
...
function module_upvr.PumpAnim(arg1) -- Line 113
end
function module_upvr.MagCheck(arg1) -- Line 117
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	arg1[4].Handle.AimUp:Play()
...
function module_upvr.meleeAttack(arg1) -- Line 129
end
function module_upvr.GrenadeReady(arg1) -- Line 133
end
function module_upvr.GrenadeThrow(arg1) -- Line 137
end
