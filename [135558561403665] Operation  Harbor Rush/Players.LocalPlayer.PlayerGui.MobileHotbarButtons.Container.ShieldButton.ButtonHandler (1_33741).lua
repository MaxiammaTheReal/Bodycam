-- Name: ButtonHandler
-- Path: game:GetService("Players").LocalPlayer.PlayerGui.MobileHotbarButtons.Container.ShieldButton.ButtonHandler
-- Class: LocalScript
-- Exploit: Xeno 
-- Time to decompile: 0.5436256000011781 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:17:33
...
local any_UserOwnsGamePassAsync_result1_upvr = game:GetService("MarketplaceService"):UserOwnsGamePassAsync(LocalPlayer_upvr.UserId, 779458953)
