-- Name: ActionsModule
-- Path: game:GetService("Workspace").GAME.Suspects.Suspect_Heavy.Scripts.Modules.ActionsModule
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.25979800000095565 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:15:34
-- Luau version 6, Types version 3
-- Time taken: 0.013045 seconds
...
function module_upvr.reload() -- Line 144
	...
	Mag_upvr.Transparency = 0
	Status_upvr:set("reloading", false)
	Status_upvr:set("mag", Parent_2_upvr.Settings.MagSize.Value)
	module_upvr.drawM4()
end
...
function module_upvr.drawM4() -- Line 174
	--[[ Upvalues[16]:
		...
		[5]: Torso_upvr (readonly)
		[6]: M4_Weld_upvr (readonly)
		[7]: HumanoidRootPart_upvr (readonly)
		[8]: HingeAttach1_upvr (readonly)
		[9]: HingeAttach0_upvr (readonly)
		[10]: HingeConstraint_upvr (readonly)
		[11]: Right_Shoulder_upvr (readonly)
		[12]: Right_Arm_Weld_upvr (readonly)
		[13]: Right_Arm_upvr (readonly)
		[14]: Left_Shoulder_upvr (readonly)
		[15]: Left_Arm_Weld_upvr (readonly)
		[16]: Left_Arm_upvr (readonly)
	]]
	module_upvr.yieldKnife()
	if not Status_upvr:get("m4Equipped") and not Status_upvr:get("reloading") then
