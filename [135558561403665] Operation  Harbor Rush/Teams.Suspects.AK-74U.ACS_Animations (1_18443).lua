-- Name: ACS_Animations
-- Path: game:GetService("Teams").Suspects['AK-74U'].ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.911634199999753 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:14
-- Luau version 6, Types version 3
-- Time taken: 0.019571 seconds
...
function module_upvr.CantedSight(arg1) -- Line 31
	...
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
		C1 = CFrame.new(0.25, -0.25, 0.5) * CFrame.Angles((math.pi/2), 0.8726646259971648, 0):inverse();
	}):Play()
	TweenService_upvr:Create(arg1[2], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.JammedAnim(arg1) -- Line 125
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.PumpAnim(arg1) -- Line 139
end
function module_upvr.MagCheck(arg1) -- Line 143
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	arg1[4].Handle.AimUp:Play()
...
function module_upvr.meleeAttack(arg1) -- Line 155
end
function module_upvr.GrenadeReady(arg1) -- Line 159
end
function module_upvr.GrenadeThrow(arg1) -- Line 163
end
