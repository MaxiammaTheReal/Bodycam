-- Name: ACS_Animations
-- Path: game:GetService("TestService")['M4 Carbine '].ACS_Animations
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.7465406000010262 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-18 07:19:21
-- Luau version 6, Types version 3
-- Time taken: 0.020275 seconds
...
function module_upvr.JammedAnim(arg1) -- Line 118
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	TweenService_upvr:Create(arg1[1], TweenInfo.new(0.25, Enum.EasingStyle.Sine), {
...
function module_upvr.PumpAnim(arg1) -- Line 132
end
function module_upvr.MagCheck(arg1) -- Line 136
	--[[ Upvalues[1]:
		[1]: TweenService_upvr (readonly)
	]]
	arg1[4].Handle.AimUp:Play()
...
function module_upvr.meleeAttack(arg1) -- Line 148
end
function module_upvr.GrenadeReady(arg1) -- Line 152
end
function module_upvr.GrenadeThrow(arg1) -- Line 156
end
